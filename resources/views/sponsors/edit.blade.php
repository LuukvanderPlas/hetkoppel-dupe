...
@section('title', 'Sponsor aanpassen')

@section('pageTitle', 'Sponsor aanpassen')
...
@section('content')
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
        action="{{ route('sponsors.update', ['sponsor' => $sponsor->id]) }}" method="POST">
        @csrf
        @method('PUT')
        <h1 class="block text-gray-700 text-lg font-bold mb-2">Update {{ $sponsor->title }}</h1>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                id="title" name="title" type="text" placeholder="Sponsor naam"
        ...
        <div class="bg-gray-200 p-4 rounded mt-4">
            ...
            <x-media-chooser :mediaId="old('image_id', $sponsor->image_id)" inputName="image_id" />
        </div>
        ...
        <div class="flex flex-col items-center justify-between sm:flex-row">
            ...
            <div class="mt-4 sm:mt-0">
                ...
                <button type="button" class="text-red-600 hover:text-red-900 cursor-pointer"
                    onclick="showDeleteDialog({{ json_encode('de sponser ' . $sponsor->name) }}, '{{ route('sponsors.destroy', ['sponsor' => $sponsor->id]) }}')">Verwijderen</button>
            </div>
        </div>
    </form>
    <x-confirm-delete />
    ...
    @cannot('edit page')
        <p class="text-red-900">
            Het recht om pagina's te bewerken is vereist om de inhoud van de sponsorenpagina aan te passen.
        </p>
    @endcannot
